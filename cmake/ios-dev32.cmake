...
#
# cmake -DCMAKE_TOOLCHAIN_FILE=ios-dev32.cmake -DCMAKE_INSTALL_PREFIX=..
#
...
add_definitions("-DIOS -fopenmp -stdlib=libc++ -miphoneos-version-min=6.0 -arch armv7 -isysroot $ENV{IOS_SDK} -I/usr/local/Cellar/llvm/4.0.0/include/c++/v1 -I/usr/local/Cellar/llvm/4.0.0/lib/clang/4.0.0/include -fPIC -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fstrict-aliasing")