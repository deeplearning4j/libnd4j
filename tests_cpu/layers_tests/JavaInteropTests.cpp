...
TEST_F(JavaInteropTests, TestShapeExposure1) {
    ...
    ASSERT_EQ(exp.rankOf(), shape::rank(shapeList->at(0)));
    ASSERT_EQ(exp.sizeAt(0), shape::shapeOf(shapeList->at(0))[0]);
    ASSERT_EQ(exp.sizeAt(1), shape::shapeOf(shapeList->at(0))[1]);
    ASSERT_EQ(exp.sizeAt(2), shape::shapeOf(shapeList->at(0))[2]);
    ASSERT_EQ(exp.sizeAt(3), shape::shapeOf(shapeList->at(0))[3]);
}
