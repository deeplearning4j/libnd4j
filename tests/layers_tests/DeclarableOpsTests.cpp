...
//////////////////////////////////////////////////////////////////////
TEST_F(DeclarableOpsTests, BatchNorm) {
    ...
    const float b = 1.;
    const float decay = 1.;
    NDArray<float> input('c', {bS, nIn});
    NDArray<float> gamma('c', {1, nIn});
    NDArray<float> beta ('c', {1, nIn});
    NDArray<float> xHat ('c', {bS, nIn});    
    NDArray<float> globalMeanView('c', {1, nIn});
    NDArray<float> globalVarView('c', {1, nIn});
    NDArray<float> output('c', {bS, nIn});
    NDArray<float> outExpected('c', {bS, nIn});
