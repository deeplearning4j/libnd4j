...
/**
   ...
   */
    ...
    Nd4jPointer mmapFile(Nd4jPointer *extraPointers, const char *fileName, Nd4jIndex length);

    void munmapFile(Nd4jPointer *extraPointers, Nd4jPointer ptrMap, Nd4jIndex length);
};
