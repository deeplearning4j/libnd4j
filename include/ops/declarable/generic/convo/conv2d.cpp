...
namespace nd4j {
    namespace ops {
        ...
        CUSTOM_OP_IMPL(conv2d, 2, 1, false, 0, 9) {
            ...
            REQUIRE_TRUE(weights->sizeAt(0) == input->sizeAt(1), 0, "Conv2D: weights dim 0 should be equal to number of input channels. But got %i vs %i. Not a NCHW?", weights->sizeAt(0), input->sizeAt(1))
